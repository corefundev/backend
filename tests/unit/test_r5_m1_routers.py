...
_EXPECTED_ROUTE_COUNT = 117  # +1 AZ-1 #465 (GET order-recommendations); 115 +1 DS-1 slice B (datasets train button); 109 +6 DS-1 #466 (datasets CRUD/attach/detach); 111 (после AUTH-1/2) −2 AUTH-4 #448:
