...
_EXPECTED_ROUTE_COUNT = 110  # 105 после LEG-3/#431; +5 AUTH-1 #445: /auth/confirm,
# /auth/login/password, /auth/password/reset-request, /auth/password/reset,
# /auth/password/change (классическая парольная аутентификация).
