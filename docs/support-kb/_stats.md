...
- Файлов знаний: **58** (+3 служебных: _inventory.md, _gaps.md, _stats.md)
- Суммарный объём: **103322 символов** (~103 тыс.)
- По источникам: code — 9, general — 25, help — 21, news — 1, ui — 2
...
| Из интерфейса (ui) | 2 |
| Общие сведения/глоссарий/сценарии (general) | 25 |
